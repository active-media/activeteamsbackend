# email_utils_annotated.py - annotated copy with explanations
from sendgrid import SendGridAPIClient
from sendgrid.helpers.mail import Mail
import os

# Read SendGrid API key and default from address from environment
...
def send_reset_email(to_email: str, recipient_name: str, reset_link: str):
    ...
    # HTML content for the reset email - styled and mobile responsive
    html_content = f"""
    <html>
      <head>
    ...
    # Build the SendGrid message object
    message = Mail(
    ...
    try:
        ...
        # Print and return None on failures
