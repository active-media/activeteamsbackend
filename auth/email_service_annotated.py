# email_service_annotated.py - annotated Resend-based email helpers
# Import environment utilities and Resend client
import os
import resend
...
def send_reset_email_resend(to_email: str, reset_link: str) -> bool:
    ...
    """
    try:
        # Build params for Resend API call including HTML and plain text body
        params = {
